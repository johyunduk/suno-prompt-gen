...
- **AI 정제** — 선택한 태그를 Suno 입력란별 결과로 변환하며, Gemini 한도 초과 시 Claude·Codex 등 외부 AI용 스타일 정제 요청문 복사 지원
- **가사 생성** — 주제·언어·곡 구조·곡 길이를 설정하면 스타일에 맞는 가사를 생성하며, Gemini 한도 초과 시 Claude·Codex 등 외부 AI용 요청문 복사 지원 (인스트루멘탈 선택 시 구조 프롬프트 모드)
- **캐릭터 이미지 분석** — 이미지를 올리면 어울리는 음악 태그를 추천
- **27개 스타일 프리셋**(대중적인 K-pop·발라드/OST·R&B·힙합·밴드/록·어쿠스틱·EDM 중심 큐레이션), 곡 구조 템플릿, 메타태그/장르/팁 레퍼런스
