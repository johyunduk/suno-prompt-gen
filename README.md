...
- **AI 정제** — 선택한 태그를 Suno 입력란별 결과로 변환: Style of Music · Exclude Styles · 권장 Advanced Options(보컬 성별/Weirdness/Style Influence) · v5.5 개인화 추천(Voices/Custom Models/My Taste)
