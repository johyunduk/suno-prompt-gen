const BASICS = [
  { num: '01', title: 'Style Prompt', desc: '장르, 악기, 분위기, BPM, 보컬 스타일을 콤마로 나열. Suno는 이 텍스트를 음악적 DNA로 해석합니다. 핵심 단어 5~8개가 최적.' },
  ...
  { num: '05', title: 'Remaster 기능', desc: '기존 생성 결과물을 더 높은 퀄리티로 재처리. v3/v4 모델로 업그레이드할 때 사용하면 음질과 구성이 개선됩니다.' },
  { num: '06', title: '버전 선택 전략', desc: 'v4가 기본이지만 특정 장르(레트로, 로파이)는 v3.5가 더 자연스럽습니다. 결과를 비교해보는 습관이 중요합니다.' },
